...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Hello Berlin!")),
...
class _Code extends StatelessWidget {
  ...
  String _screenReaderFriendlyText(String text) {
    return text.characters.map(_spellOutCharacters).reduce((a, b) => '$a, $b');
  }

  String _spellOutCharacters(String char) {
    ...
    return Center(
      child: SizedBox(
        ...
        child: ColoredBox(
          ...
          child: Center(
            child: Semantics(
              label: 'Access code: ${_screenReaderFriendlyText(code)}',
